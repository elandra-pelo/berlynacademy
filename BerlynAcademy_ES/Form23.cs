...
namespace BerlynAcademy_ES
{
    public partial class frmPrincipalMain : Form
    {
        ...
        private void frmPrincipalMain_FormClosing(object sender, FormClosingEventArgs e)
        {
            LOGOUT();
            frmEmpLogin home = new frmEmpLogin();
            this.Hide();
        ...
        private void btnAbtPrin_Click(object sender, EventArgs e)
        {
            ...
            this.Hide();
            ea.ablog = prinlog;
            ea.emptype = "principal";
            ea.Show();
        }

        private void btnReprin_Click(object sender, EventArgs e)
        {
            frmReport rfp = new frmReport();
            this.Hide();
            rfp.emptype = "principal";
            rfp.replog = prinlog;
            rfp.Show();
        }
        ...
        {
            frmFacInfo fip = new frmFacInfo();
            this.Hide();
            fip.facinfolog = prinlog;
            fip.emptype = "principal";
            fip.Show();
        }
