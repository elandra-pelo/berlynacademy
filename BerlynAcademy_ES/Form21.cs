...
namespace BerlynAcademy_ES
{
    public partial class frmCashierMain : Form
    {
        ...
        public string cashlog, CO, accesscode, emptype, thefac, VISITED, notifstat,activeSY,activeYr;
        ...
        private void frmCashierMain_Load(object sender, EventArgs e)
        {
            ...
            lblLoggerCas.Text = cashlog;
            lblLoggerCasPosition.Text = "Cashier";
            //btnHome.Text = "          " + cashlog;
            //MessageBox.Show(CO);
            GetActiveSchoolYear();
            setupactivities();
            setupMENU();
        ...
        private void frmCashierMain_FormClosing(object sender, FormClosingEventArgs e)
        {
            LOGOUT();
            frmEmpLogin home = new frmEmpLogin();
            this.Hide();
        ...
        private void btnPay_Click(object sender, EventArgs e)
        {
            ...
            this.Hide();
            payform.paylog = cashlog;
            payform.CashierOperator = CO;
            payform.Show();
        }
